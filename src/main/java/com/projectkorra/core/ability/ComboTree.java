...
public class ComboTree {
	...
	private ComboTree(String ability, Activation trigger, ComboTree root) {
	 ...
	 */
	private ComboTree branch(String ability, Activation trigger) {
	 ...
	 */
	static List<SequenceInfo> build(List<SequenceInfo> sequence) throws IllegalArgumentException {
