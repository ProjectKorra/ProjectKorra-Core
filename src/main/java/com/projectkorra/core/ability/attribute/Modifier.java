...
public interface Modifier {
	...
	/**
	 * Returns the empty modifier that just returns the object
	 * it is given
	 */
	public static Modifier EMPTY = (o) -> o;
	
	/**
	 * Takes in a value and does something with it. Since the
	 * given value is an Object, you must check if the value is
	 * an <code>instanceof</code> the data type you wish to work
	 * with, and if the value is not then just return the value
	 * unmodified. 
	...
	/**
	 * Composes the modifiers together such that this
	 * modifier is applied and then the <code>other</code>
	 * modifier is applied.
	...
	/**
	 * Returns a premade modifier for doing division. The modifier
