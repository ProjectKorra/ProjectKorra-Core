...
public abstract class SourceInstance {
	...
	/**
	 * Attempts to use the source. If usable, returns the location to source from,
	...
	/**
	 * Called to display something to the user to know that they have a source
	 * selected. Typically particles on the source location or around the user
	 */
