...
public class ParticleUtil {
	 ...
	 * @param particle what particle to spawn
	 * @param loc      where to spawn the particle
	 * @param data     additional data attached to the particle. See
	 *                 {@link Particle} for applicable data types
	 */
	...
	/**
	 * Spawn an amount of particles at the given location and with any additional
	 * data
	 * 
	 * @param particle what particle to spawn
	 * @param loc      where to spawn the particle
	 * @param amount   how many of the particle to spawn
	 * @param extra    additional number attached to the particle (usually speed in
	 *                 some way)
	 */
	...
	/**
	 * Spawn an amount of particles at the given location within the specified
	 * bounds and with any additional data
	 * 
	 * @param particle what particle to spawn
	 * @param loc      where to spawn the particle
	 * @param amount   how many of the particle to spawn
	 ...
	 *                 {@link Particle} for applicable data types
	 */
	public static void spawn(Particle particle, Location loc, int amount, double offsetX, double offsetY,
	...
	/**
	 * Spawn a single BLOCK_CRACK particle with the given BlockData at the given
	 * Location
	 * 
	...
	/**
	 * Spawn an amount of the BLOCK_CRACK particle with the given BlockData at the
	 * given Location
	 * 
	 * @param block  BlockData for the BLOCK_CRACK particle to show
	 * @param loc    where to spawn the particle
	...
	/**
	 * Spawn an amount of the BLOCK_CRACK particle with the given BlockData at the
	 * given Location within the specified bounds
	 * 
	 * @param block   BlockData for the BLOCK_CRACK particle to show
	 * @param loc     where to spawn the particle
	 * @param amount  how many of the particle to spawn
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnBlockCrack(BlockData block, Location loc, int amount, double offsetX, double offsetY,
			double offsetZ) {
		if (block == null) {
	...
	/**
	 * Spawn a single BLOCK_DUST particle with the given BlockData at the given
	 * Location
	 * 
	...
	/**
	 * Spawn an amount of the BLOCK_DUST particle with the given BlockData at the
	 * given Location
	 * 
	 * @param block  BlockData for the BLOCK_DUST particle to show
	 * @param loc    where to spawn the particle
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnBlockDust(BlockData block, Location loc, int amount, double offsetX, double offsetY,
			double offsetZ) {
		if (block == null) {
			block = Material.BARRIER.createBlockData();
		}
	...
	/**
	 * Spawn a single FALLING_DUST particle with the given BlockData at the given
	 * Location
	 * 
	...
	/**
	 * Spawn an amount of the FALLING_DUST particle with the given BlockData at the
	 * given Location
	 * 
	 * @param block  BlockData for the FALLING_DUST particle to show
	 * @param loc    where to spawn the particle
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnFallingDust(BlockData block, Location loc, int amount, double offsetX, double offsetY,
			double offsetZ) {
		if (block == null) {
			block = Material.BARRIER.createBlockData();
		}
	...
	/**
	 * Spawn a single ITEM_CRACK particle with the given ItemStack at the given
	 * Location
	 * 
	...
	/**
	 * Spawn an amount of the ITEM_CRACK particle with the given ItemStack at the
	 * given Location
	 * 
	 * @param item   ItemStack for the ITEM_CRACK particle to show
	 * @param loc    where to spawn the particle
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnItemCrack(ItemStack item, Location loc, int amount, double offsetX, double offsetY,
			double offsetZ) {
		if (item == null) {
	...
	/**
	 * Spawn an amount of colored NOTE particles at the given Location within the
	 * specified bounds
	 * 
	 * @param color   which color the note should be
	 * @param loc     where to spawn the particle
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnColoredNote(NoteColor color, Location loc, int amount, double offsetX, double offsetY,
			double offsetZ) {
	...
	/**
	 * Spawn a single colored REDSTONE particle at the given Location and a size of
	 * 1
	 * 
	...
	/**
	 * Spawn an amount of colored REDSTONE particles at the given Location and a
	 * size of 1
	 * 
	 * @param color  color of the particle
	 * @param loc    where to spawn the particle
	...
	/**
	 * Spawn an amount of colored REDSTONE particles at the given Location within
	 * the specified bounds and a size of 1
	 * 
	 * @param color   color of the particle
	 * @param loc     where to spawn the particle
	 * @param amount  how many of the particle to spawn
	 ...
	 * 
	 * @param color   color of the particle
	 * @param size    size of the particle [0, ~4] (size seems to be capped around
	 *                4)
	 * @param loc     where to spawn the particle
	 * @param amount  how many of the particle to spawn
	 * @param offsets offset bounds for equal randomized spawning on each axis
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnColoredRedstone(Color color, float size, Location loc, int amount, double offsetX,
	...
	/**
	 * Spawn an amount of colored SPELL particles at the given Location within the
	 * specified bounds
	 * 
	 * @param color   color of the particle
	 * @param ambient if true, the particles will be considerably transparent
	 ...
	 * @param offsetZ z-axis offset bounds for randomized spawning
	 */
	public static void spawnColoredSpell(Color color, boolean ambient, Location loc, int amount, double offsetX,
			double offsetY, double offsetZ) {
		if (color == null) {
			color = Color.WHITE;
		}
	...
	/**
	 * Spawns a single particle that moves from the given Location in the given
	 * direction using the magnitude of the direction vector as the speed
	 * 
	...
	/**
	 * Spawns an amount of particles that move from the given Location in the given
	 * direction at the given speed
	 * 
	 * @param particle  a particle which can have direction applied to it
	 * @param direction which direction to move the particles
	...
	/**
	 * Spawns an amount of particles that move from the given Location within the
	 * specified bounds in the given direction at the given speed
	 * 
	 * @param particle  a particle which can have direction applied to it
	 * @param direction which direction to move the particles
	 * @param speed     how fast to move the particle
	...
	public static void spawnWithDirection(DirectionalParticle particle, Vector direction, double speed, Location loc,
		...
		for (int i = 0; i < amount; i++) {
			...
			world.spawnParticle(particle.get(), x, y, z, 0, direction.getX(), direction.getY(), direction.getZ(),
					speed);
		}
	}
