...
public class ThreadUtil {
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runTaskAsynchronously(BukkitRunnable runnable)
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runDelayedTask(BukkitRunnable runnable, long delay)
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runDelayedTaskAsynchronously(BukkitRunnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runDelayedTaskAsynchronously(Runnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTask(BukkitRunnable runnable)
			throws NullPointerException, IllegalStateException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTask(BukkitRunnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTask(Runnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
		return runRepeatingTask(runnable, delay, 0L);
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTask(BukkitRunnable runnable, long delay, long period)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTask(Runnable runnable, long delay, long period)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
		Preconditions.checkArgument(period >= 0, "period cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(BukkitRunnable runnable)
			throws NullPointerException, IllegalStateException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(Runnable runnable)
			throws NullPointerException, IllegalStateException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		return runRepeatingTaskAsynchronously(runnable, 0L, 0L);
	}
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(BukkitRunnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(Runnable runnable, long delay)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
		return runRepeatingTaskAsynchronously(runnable, delay, 0L);
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(BukkitRunnable runnable, long delay, long period)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
		Preconditions.checkArgument(period >= 0, "period cannot be negative");
	 ...
	 * @since 0.0.1
	 */
	public static BukkitTask runRepeatingTaskAsynchronously(Runnable runnable, long delay, long period)
			throws NullPointerException, IllegalStateException, IllegalArgumentException {
		Preconditions.checkNotNull(runnable, "runnable cannot be null");
		Preconditions.checkArgument(delay >= 0, "delay cannot be negative");
		Preconditions.checkArgument(period >= 0, "period cannot be negative");
