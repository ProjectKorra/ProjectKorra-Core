...
public abstract class PKSubCommand {
	...
	public PKSubCommand(String name, String description, String usage, List<String> aliases) {
	...
	public abstract List<String> tabComplete(CommandSender sender, int argCount);
